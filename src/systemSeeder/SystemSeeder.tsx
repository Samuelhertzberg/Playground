...
import { Engine, Render, Bodies, Body, World, Composite, Runner, Vector, Events, use, MouseConstraint, Pair, Query } from 'matter-js'
...
const SystemSeeder = () => {
  ...
  useEffect(() => {
     ...
     */
    const createBody = (position: Vector, radius: number, mass: number, velocity: Vector): Body => {
     ...
     */
    const fuseBodies = (b1: Body, b2: Body) => createBody(
      getMassCenter(b1, b2),

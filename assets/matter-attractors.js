...
var MatterAttractors = {
  ...
  Attractors: {
    ...
    gravity: function gravity(bodyA, bodyB) {
      // const getR = ({ min, max }) => (max.x - min.x) / 2
      // const rA = getR(bodyA.bounds)
      // const rB = getR(bodyB.bounds)
      // const minDistSq = (rA + rB) ** 2

      // use Newton's law of gravitation
      var bToA = Matter.Vector.sub(bodyB.position, bodyA.position),
          // distanceSq = Math.max(Matter.Vector.magnitudeSquared(bToA) || 0.0001, minDistSq),
          distanceSq = Matter.Vector.magnitudeSquared(bToA) || 0.0001,
          normal = Matter.Vector.normalise(bToA),
          magnitude = -MatterAttractors.Attractors.gravityConstant * (bodyA.mass * bodyB.mass / distanceSq),
          force = Matter.Vector.mult(normal, magnitude);
      // if(force.x > 0.004 || force.y > 0.004) {
      //   const ax = bodyA.position.x
      //   const ay = bodyA.position.y
      //   const bx = bodyB.position.x
      //   const by = bodyB.position.y
      //   console.log("SUSPICIOUSLY ENERGETIC EVENT");
      //   console.log("BODIES::");
      //   console.log(ax);
      //   console.log(ay);
      //   console.log("------");
      ...
      //   console.log(by);
      //   console.log("DIST");
      //   console.log(Math.sqrt((ax-bx)**2 + (ay-by)**2));
